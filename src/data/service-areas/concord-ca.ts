...
export const data: ServiceAreaCity = {
  ...
  adjective: 'Trusted',
  title: 'Trusted ADU Contractors in Concord, CA | Hamilton Exteriors',
  ...
  faqs: [
    {
      question: 'How long does it take to build an ADU in Concord?',
      answer: 'A typical Concord ADU project takes 6-10 months from design to completion. This includes 2-4 weeks for design, 60 days for permits, and 4-6 months for construction. Our streamlined process and local expertise help minimize delays.',
    },
    {
      question: 'How much does an ADU cost in Concord?',
      answer: 'ADU costs in Concord range from $60,000 for a Junior ADU to $350,000+ for a large detached unit. The final cost depends on size, design complexity, site conditions, and finishes. We offer $0 down financing and free consultations to help you understand all costs upfront.',
    },
    {
      question: 'Do I need a permit to build an ADU in Concord?',
      answer: 'Yes, all ADUs in Concord require building permits. We handle the entire permit process for you and work to get your permits approved as quickly as possible.',
    },
  ],

  contact: {
    title: 'Get Your Free Concord ADU Consultation',
    subtitle: "Ready to build your dream ADU? Schedule a free consultation with our Concord ADU experts. We'll visit your property, discuss your goals, and provide a detailed estimate at no cost.",
  ...
  whyChoose: {
    ...
    features: [
      ...
      { title: 'Permit Expertise', description: 'Smooth permitting with deep knowledge of local regulations, ensuring your ADU project gets approved without costly delays or revisions.' },
      { title: 'Quality Build', description: 'Premium materials and skilled construction that meet the highest standards, ensuring your ADU is built to last and delivers lasting comfort.' },
      { title: 'Clear Timelines', description: 'Detailed construction schedules with realistic milestones and regular progress updates, so you always know exactly where your project stands.' },
    ],
  },
  whyEssential: {
