...
export const data: ServicePageData = {
  ...
  description:
    'Bay Area siding contractor, James Hardie Elite Preferred installer. Fiber cement, vinyl, and stucco engineered for fog + fire zones. CSLB #1078806. Free estimate.',
