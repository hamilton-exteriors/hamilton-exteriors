...
function buildPrompt(ctx) {
  ...
  return [
    ...
    "- Barns, warehouses, sheds, industrial buildings, commercial properties, abandoned houses",
    "- European or tropical architecture (clay village roofs, thatched roofs, corrugated tin shacks)",
    "- Food, minerals, crystals, salt, sand, gravel, or any non-construction close-up that looks like granules but isn't roofing material",
    "- Golf courses, mansions, estates that look like luxury real estate photos rather than contractor work",
    "- Cedar shake SIDING painted red/brown (this is siding, not roofing — wrong trade)",
    "- Watermarks or stock agency logos",
    "- Obviously AI-generated",
    "- Clip art, illustrations, diagrams",
    "- Interior-only shots (unless showing daylight through roof boards from an attic)",
    "- Animals as the main subject",
    "- Heavy artistic filters, vintage postcards, moody desaturated color grading",
    "- Old European clay/terracotta village roofs with moss (not American residential)",
    "",
